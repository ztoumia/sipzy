  ...
  return (
    <PageLayout>
      <div className="bg-cream-50 py-8">
        <Container>
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-coffee-800 mb-2">Gestion des Utilisateurs</h1>
            <p className="text-coffee-600">Gérez les comptes utilisateurs</p>
          </div>

          <div className="bg-white border-2 border-coffee-200 rounded-lg p-8 text-center">
            <Users className="w-16 h-16 text-coffee-400 mx-auto mb-4" />
